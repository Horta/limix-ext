# import numpy as np
# import unittest
# from limix_ext.lmm.heritability import estimate
#
...
#         self.assertAlmostEqual(h2, 0.81995708512)
#
...
#         ntrials = np.ones(n)
#
#         h2 = estimate(y, covariate, K, prevalence, ntrials=ntrials)
#         self.assertAlmostEqual(h2, 0.7461609)
#
